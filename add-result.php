...
for($i=0;$i<count($mark);$i++){
    $mar=$mark[$i];
  $sid=$sid1[$i];
$sql="INSERT INTO  tblresult(StudentId,ClassId,SubjectId,marks,attendance,att) VALUES(:studentid,:class,:sid,:marks,:attendance,:att)";
...
{   ?>
<option value="<?php echo htmlentities($result->id); ?>"><?php echo htmlentities($result->ClassName); ?>&nbsp; year-<?php echo htmlentities($result->Section); ?></option>
<?php }} ?>
 </select>
                                                        </div>
                                                    </div>
<div class="form-group">
                                                    ...
                                                    <input type="text" name="attendance" value="" class="form-control stid" required="" placeholder="Total Attendence" autocomplete="off">
                                                    <input type="text" name="att" value="" class="form-control stid" required="" placeholder="Total Attended" autocomplete="off">
